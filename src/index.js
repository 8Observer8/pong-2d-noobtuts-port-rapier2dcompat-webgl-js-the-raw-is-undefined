...
async function init() {
    ...
    leftRacketRBDesc.setTranslation(-20 / pixelsPerMeter, -2.5 / pixelsPerMeter);
    ...
    function render() {
        ...
        //         console.log(ballRigidBody);
        //         const racketPosY = leftRacketRigidBody.translation().y * pixelsPerMeter;
        //         const y = hitFactor(ballPosY, racketPosY, leftRacketHalfHeight);
        //         console.log(y);
        ...
        // world.intersectionsWith(ballCollider, (otherCollider) => {
        //     console.log("ok");
        // });
